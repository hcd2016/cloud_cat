...
public class MySlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public void setiGravity(int iGravity) {
        this.iGravity = iGravity;
    }

    private int iGravity=0;//0为居中,1为居左
...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
    ...
    private void scrollToCurrentTab() {
        ...
        if(iGravity == 0) {
            ...
            newScrollX -= getWidth()  - getPaddingLeft();
            calcIndicatorRect();
            newScrollX += ((mTabRect.right - mTabRect.left) );
        }
    ...
    private void calcIndicatorRect() {
        ...
        if (this.mCurrentTab < mTabCount - 1) {
            ...
            if (mIndicatorStyle == STYLE_NORMAL && mIndicatorWidthEqualTitle) {
                ...
                float nextMargin = (nextTabRight - nextTabLeft - nextTextWidth) ;
