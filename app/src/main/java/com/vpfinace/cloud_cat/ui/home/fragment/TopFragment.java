...
public class TopFragment extends BaseFragment {
    ...
    protected void initView() {
        ...
        List<TopTypeBean> list = new ArrayList<>();
        for (int i = 0; i < 20; i++) {
            TopTypeBean topTypeBean = new TopTypeBean(type);
            list.add(topTypeBean);
        }
    ...
    class MyAdapter extends BaseMultiItemQuickAdapter<TopTypeBean,BaseViewHolder> {
        /**
         ...
         */
        public MyAdapter(List<TopTypeBean> data) {
            super(data);
        ...
        @Override
        protected void convert(BaseViewHolder helper, TopTypeBean item) {
